...
class Surface3 extends JPanel {
    ...
    public void doFall() {
        ...
        for (int k = 0; k < 10; k = k + 2) {
            if ((tab[14][k] == 1 && tab[14][k + 1] == 2) || (tab[14][k] == 1 && tab[14][k + 1] == 1)) {
                tab[14][k] = 0;
            } else if ((tab[14][k] == 1 && tab[14][k + 1] == 0)) {
                tab[14][k] = 0;
                tab[14][k] = 1;
            }
        }
...
//            s = " ";
    ...
    public void paintComponent(Graphics g) {
        ...
        System.out.println("DoPic1");
        

    }
}

public class Sand extends JFrame {

    private Surface3 surf;
